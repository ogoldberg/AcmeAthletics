...
<%@ page import="com.oren.acmeathletes.auth.ShiroUser" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: shiroUserInstance, field: 'roles', 'errors')}">
                                    <g:select name="roles" from="${com.oren.acmeathletes.auth.ShiroRole.list()}" multiple="yes" optionKey="id" size="5" value="${shiroUserInstance?.roles}" />
                                </td>
                            </tr>
