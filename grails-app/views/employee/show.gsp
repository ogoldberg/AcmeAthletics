            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="employee.accountNumber.label" default="Account Number" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: employeeInstance, field: "accountNumber")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="employee.status.label" default="Status" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: employeeInstance, field: "status")}</td>
